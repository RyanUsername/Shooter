...
display.set_caption("Space Showoter")
...
while run:
    ...
    if not finish:
        ...
        restart_text = font3.render("Press R to restart the gane!", True, (255, 255, 255))
        window.blit(restart_text, (130, 500))

        restart_text = font3.render("Press X to restart the gane!", True, (255, 255, 255))
